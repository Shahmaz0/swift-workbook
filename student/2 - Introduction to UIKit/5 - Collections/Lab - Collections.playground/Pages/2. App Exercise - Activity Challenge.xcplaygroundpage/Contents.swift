 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 5 miles a day"]
var runningChallenges: [String] = ["Run 5 times a week", "Run 10 times a week"]
...
var userChallenges: [String] = ["Walk 3 miles a day, Run 5 times a week."]
...
if (userChallenges.isEmpty) {
    ...
    print("The challenge you have choose is \(challenges[0])")
}else {
    print("You have choosen multiple challeges.")
}
