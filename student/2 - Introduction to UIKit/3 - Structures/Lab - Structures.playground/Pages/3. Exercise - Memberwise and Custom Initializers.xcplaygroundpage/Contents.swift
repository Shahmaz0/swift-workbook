...
var somePlace = GPS(latitude: 51.514004, longitute: 0.125226)
...
var favouriteBook = Book(title: "The Alchemist", author: "Paulo Coelho", pages: 250, price: 20.00)
print("My favorite book is \(favouriteBook.title) by \(favouriteBook.author) which comes with \(favouriteBook.pages) pages and costs \(favouriteBook.price).")
...
var laptop1 = Laptop(yearPurchased: 20)
var laptop2 = Laptop(yearPurchased: 202)
