...
print("Sum of Heart Rates: \(addedHr)")
...
print("Sum of Heart Rates: \(addedHRD)")
print("Average Heart Rate: \(averageHRD)")

print("Yes, Results are different from above average, because we did't gave any type annotation to all variable that's why they are all inferred automatically as Integer and here we assigned all the variables as double that's why we are getting average as double.")
...
print("The task accompolished is ",percentOfGoal,"%")
/*:
