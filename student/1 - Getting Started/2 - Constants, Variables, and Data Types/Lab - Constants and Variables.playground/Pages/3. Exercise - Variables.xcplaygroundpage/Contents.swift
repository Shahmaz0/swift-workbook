...
print("Yes, It compiled successfully")
print("It is different than trying to update a constant because constants are immutable whereas var is mutable, we can change its values")
